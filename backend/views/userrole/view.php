                ...
                <div class="panel-body p-0 table-responsive">					  
					  <table class="table w-100 table-striped mb-0">
						...
						<tr>
							...
							<td><?php echo ($userdetails->gender != '') ? (($userdetails->gender)?"Male":"Female"):null;?></td>
						</tr>
						<tr>
...
<!-- 						</tr> -->
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="farms">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="crops">
                <div class="panel-body">
